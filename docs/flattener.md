...
npx be-calm flatten --input /path/to/source/directory
npx be-calm flatten -i /path/to/source/directory

# Specify custom output file
npx be-calm flatten --output my-project.xml
npx be-calm flatten -o /path/to/output/codebase.xml

# Combine input and output options
npx be-calm flatten --input /path/to/source --output /path/to/output/codebase.xml
```
