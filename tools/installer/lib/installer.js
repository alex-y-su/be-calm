...
class Installer {
  ...
  showSuccessMessage(config, installDir, options = {}) {
    ...
    if (config.installType === 'single-agent') {
      console.log(chalk.dim('\nNeed other agents? Run: npx be-calm install --agent=<name>'));
      console.log(chalk.dim('Need everything? Run: npx be-calm install --full'));
    }
  ...
  async listAgents() {
    ...
    console.log(chalk.dim('\nInstall with: npx be-calm install --agent=<id>\n'));
  }
  ...
  async listExpansionPacks() {
    ...
    console.log(chalk.dim('Install with: npx be-calm install --full --expansion-packs <id>\n'));
  }
